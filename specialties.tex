...
\usubsubsection{Seismic Crucible \hrulefill X pts}
...
\usubsubsection{Gaze of the Abyss} \label{Gaze of the Abyss}
...
\begin{tabular}{|Z{15pt} Z{450pt}|}
	...
	\hline
	1 & No Effect \\
%	2-3 & tA Vehicle Unit Type that is part of the target unit suffers 1 Glancing Hit if Shard Level, or 2 if Transcendent level. Any other model suffers 1 or 2 Wounds respectively. Only Invulnerable Saves or Damage Mitigation rolls may be taken against these. \\
