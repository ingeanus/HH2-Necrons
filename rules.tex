...
\usubsubsection{Annihilation Protocols} \label{Annihilation Protocols}
...
\usubsubsection{Exile Ray (X)} \label{Exile Ray}
...
\usubsubsection{Tomb Guardians} \label{Tomb Guardians}
