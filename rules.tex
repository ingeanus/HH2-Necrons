...
Infantry and Vehicles with this rule have \textbf{It Will Not Die (5+)}. Ssuccessful Wounds inflicted by attacks with the Poisoned or Fleshbane special rules must be re-rolled. Leadership penalties caused by the Anethema sub-type are ignored.
