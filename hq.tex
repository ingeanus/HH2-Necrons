...
\begin{minipage}[t]{0.72\textwidth}
	{\large \textbf{Lord \dotfill X Points}}
	...
	\begin{itemize}
		...
		\begin{itemize}			
			\item \quickref{Hyperphase Sword} \dotfill X pt
			\item \quickref{Voidblade} \dotfill 0 pt
			\item \quickref{Warscythe} \dotfill X pt
			\item \quickref{Warscythe} with in-built \quickref{Relic Gauss Blaster} \dotfill X pt
		\end{itemize}
		\item The Lord may take any of the following options:
		\begin{itemize}
			\item \quickref{Gauntlet of Fire} \dotfill X pt
			\item \quickref{Tachyon Arrow} \dotfill X pt
			\item \quickref{Mindshackle Scarabs} \dotfill X pt
			\item \quickref{Phase Shifter} \dotfill X pt
			\item \quickref{Phylactery} \dotfill X pt
			\item \quickref{Resurrection Orb} \dotfill X pt
			\item \quickref{Translocation Shroud} \dotfill X pt
		\end{itemize}
...
\begin{minipage}[t]{0.72\textwidth}
	{\large \textbf{Nemesor Lord \dotfill X Points}}
	...
	\begin{itemize}
		...
		\begin{itemize}			
			\item \quickref{Hyperphase Sword} \dotfill X pt
			\item \quickref{Rod of Night} \dotfill X pt
			\item \quickref{Voidblade} \dotfill X pt
			\item \quickref{Warscythe} \dotfill X pt
			\item \quickref{Warscythe} with in-built \quickref{Relic Gauss Blaster} \dotfill X pt
		\end{itemize}
		\item A Nemesor Lord without a Two-Handed weapon may take a \quickref{Dispersion Shield} \dotfill X pt
		...
		\begin{itemize}
			...
			\item \quickref{Phylactery} \dotfill X pt
			\item \quickref{Resurrection Orb} \dotfill X pt
			\item \quickref{Sempiternal Weave} \dotfill X pt
			\item \quickref{Tesseract Labyrinth} \dotfill X pt
			\item \quickref{Translocation Shroud} \dotfill X pt
		\end{itemize}
...
\hspace{0.5em}
\begin{minipage}[t]{0.72\textwidth}
	{\large \textbf{Nemesor Overlord \dotfill X Points}}
	...
	\begin{itemize}
		...
		\begin{itemize}			
			...
			\item \quickref{Warscythe} with in-built \quickref{Relic Gauss Blaster} \dotfill X pt
		\end{itemize}
		\item A Nemesor Overlord without a Two-Handed weapon may take a \quickref{Dispersion Shield} \dotfill X pt
		...
		\begin{itemize}
			...
			\item \quickref{Resurrection Orb} \dotfill X pt
			\item \quickref{Sempiternal Weave} \dotfill X pt
			\item \quickref{Shadow Ankh} \dotfill X pt
			\item \quickref{Tesseract Labyrinth} \dotfill X pt
			\item \quickref{Translocation Shroud} \dotfill X pt
		\end{itemize}
...
\begin{minipage}[t]{0.72\textwidth}
	...
	\begin{itemize}
		...
		\begin{itemize}			
			...
			\item \quickref{Warscythe} with in-built \quickref{Relic Gauss Blaster} \dotfill X pt
		\end{itemize}
		\item A Phaeron without a Two-Handed weapon may take a \quickref{Dispersion Shield} \dotfill X pt
...
\begin{tabular}{||m{10pt} m{95pt} m{30pt} m{11pt} m{11pt} m{11pt} m{11pt} m{11pt} m{11pt} m{11pt} m{200pt}||}
	...
	\hline
	1 & Catacomb Command Barge & X pts & 12" & 4 & 11 & 11 & 11 & 3 & 1 & Vehicle (Chariot, Fast, Living Metal, Open-Topped, Skimmer) \\
	\hline
	\hline
...
\begin{tabular}{||m{10pt} m{90pt} m{30pt} m{11pt} m{11pt} m{11pt} m{11pt} m{11pt} m{11pt} m{11pt} m{11pt} m{11pt} m{11pt} m{135pt}||}
	...
	\hline
	1 & Royal Warden & X pts & 7" & 4 & 4 & 5 & 5 & 2 & 2 & 2 & 10 & 3+ & Infantry (Character, Living Metal)\\
	\hline
	\hline
...
\begin{tabular}{||m{10pt} m{90pt} m{30pt} m{11pt} m{11pt} m{11pt} m{11pt} m{11pt} m{11pt} m{11pt} m{11pt} m{11pt} m{11pt} m{135pt}||}
	...
	No & Name & & M & WS & BS & S & T & W & I & A & LD & Sv & Type \\
	\hline
	1 & Vargard & X pts & 7" & 5 & 4 & 5 & 5 & 2 & 2 & 3 & 10 & 3+ & Infantry (Character, Living Metal)\\
	\hline
	\hline
...
\begin{tabular}{||m{10pt} m{90pt} m{30pt} m{11pt} m{11pt} m{11pt} m{11pt} m{11pt} m{11pt} m{11pt} m{11pt} m{11pt} m{11pt} m{135pt}||}
	...
	No & Name & & M & WS & BS & S & T & W & I & A & LD & Sv & Type \\
	\hline
	1 & Cryptek & X pts & 6" & 4 & 4 & 4 & 5 & 2 & 2 & 1 & 10 & 4+ & Infantry (Character, Living Metal)\\
	\hline
	\hline
...
\begin{tabular}{||m{10pt} m{90pt} m{30pt} m{11pt} m{11pt} m{11pt} m{11pt} m{11pt} m{11pt} m{11pt} m{11pt} m{11pt} m{11pt} m{135pt}||}
	...
	No & Name & & M & WS & BS & S & T & W & I & A & LD & Sv & Type \\
	\hline
	1 & Cryptek Lord & X pts & 6" & 4 & 4 & 5 & 5 & 2 & 2 & 1 & 10 & 3+ & Infantry (Character, Living Metal)\\
	\hline
	\hline
	\multicolumn{14}{||Z{532 pt}||}{Must include a selection from the Canoptek Conclave Disciplines}\\
	\hline
