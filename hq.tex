...
\begin{minipage}[t]{0.72\textwidth}
	{\large \textbf{Cryptek \dotfill X Points}}
	
	\begin{tabular}{m{165 pt} *{10}{c}}
		& M & WS & BS & S & T & W & I & A & Ld & Sv \\
		\hline
		Cryptek & 6 & 4 & 4 & 4 & 5 & 2 & 2 & 1 & 10 & 4+ \\
	\end{tabular}
	\small
	\begin{minipage}[t]{0.5\textwidth}
		\begin{flushleft}
	...
	\textbf{Conclave Disciple:} When taking a Cryptek model, you must select a \quickref{Cryptek Conclave} for that model.
	...
	\textbf{Options}
	\begin{itemize}
		\item The Cryptek may take any of the following options:
		\begin{itemize}
			\item \quickref{Mindshackle Scarabs} \dotfill +20 points
			\item \quickref{Phase Shifter} \dotfill +25 points
			\item \quickref{Phylactery} \dotfill +10 points
...
\hspace{0.5em}
\begin{minipage}[t]{0.72\textwidth}
	{\large \textbf{Cryptek Lord \dotfill X Points}}
	
	\begin{tabular}{m{165 pt} *{10}{c}}
		& M & WS & BS & S & T & W & I & A & Ld & Sv \\
		\hline
		Cryptek Lord & 6 & 4 & 5 & 5 & 5 & 2 & 2 & 1 & 10 & 3+ \\
	\end{tabular}
	\small
	\begin{minipage}[t]{0.5\textwidth}
		\begin{flushleft}
	...
	\textbf{Conclave Disciple:} When taking a Cryptek Lord model, you must select a \quickref{Cryptek Conclave} for that model.
