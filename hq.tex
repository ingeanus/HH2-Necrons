...
\begin{tabular}{||m{10pt} m{95pt} m{30pt} m{11pt} m{11pt} m{11pt} m{11pt} m{11pt} m{11pt} m{11pt} m{11pt} m{11pt} m{11pt} m{125pt}||}
	...
	\multicolumn{14}{||Z{532 pt}||}{Wargear Options:} \\	\multicolumn{14}{||Z{532 pt}||}{\begin{itemize}
			...
			\begin{itemize}
				...
				\item \quickref{Voidblade} \hrulefill X pt
...
\begin{tabular}{||m{110pt} m{30pt} m{31pt} m{55pt} m{12pt} m{12pt} m{210pt}||}
	...
	\quickref{Voidblade} & X pt & — & Melee & User & 4 & \quickref{Entropic Strike} (6+), Rending(6+) \\
	\quickref{Warscythe} & X pt & — & Melee & +2 & 2 & Armourbane (Melee), Two-Handed \\
...
\begin{tabular}{||m{110pt} m{30pt} m{31pt} m{55pt} m{12pt} m{12pt} m{210pt}||}
	...
	\quickref{Hyperphase Sword} & X pt & — & Melee & User & 3 & Rending (5+) \\
	\quickref{Voidblade} & X pt & — & Melee & User & 4 & \quickref{Entropic Strike} (6+), Rending(6+) \\
	\quickref{Voidscythe} & X pt & — & Melee & x2 & 1 & \quickref{Entropic Strike} (5+), Brutal (2), Unwieldy, Two-Handed \\
	\quickref{Warscythe} & X pt & — & Melee & +2 & 2 & Armourbane (Melee), Two-Handed \\
	\quickref{Relic Gauss Blaster} & & 30" & Rapid Fire 2 & 5 & 4 & \quickref{Gauss} (6+), Master-Crafted \\
	\hline
\end{tabular}
...
\begin{tabular}{||m{110pt} m{30pt} m{31pt} m{55pt} m{12pt} m{12pt} m{210pt}||}
	...
	\quickref{Hyperphase Sword} & X pt & — & Melee & User & 3 & Rending (5+) \\
	\quickref{Voidblade} & X pt & — & Melee & User & 4 & \quickref{Entropic Strike} (6+), Rending(6+) \\
	\quickref{Voidscythe} & X pt & — & Melee & x2 & 1 & \quickref{Entropic Strike} (2+), Brutal (2), Unwieldy, Two-Handed \\
	\quickref{Warscythe} & X pt & — & Melee & +2 & 2 & Armourbane (Melee), Two-Handed \\
	\quickref{Relic Gauss Blaster} & & 30" & Rapid Fire 2 & 5 & 4 & \quickref{Gauss} (6+), Master-Crafted \\
	\hline
\end{tabular}
...
\begin{tabular}{||m{532pt}||}
	...
	Lord's Retainer: If a unit contains a Vargard as well as one or more models with the Character Unit Sub-type, any Wounds which would be allocated to the Character (even those caused by the Precision Strikes (X) or Sniper special rules) may instead	be allocated to a Vargard first. \\
	\hline
\end{tabular}
