...
\begin{minipage}[t]{0.72\textwidth}
	...
	\begin{minipage}[t]{0.5\textwidth}
		...
		\textbf{Unit Type}
		\begin{itemize}
			\item Infantry (Character, \quickref{Living Metal}, Noble)
		\end{itemize}
...
\begin{minipage}[t]{0.72\textwidth}
	{\large \textbf{Phaeron \dotfill 85 points}}
	...
	\textit{Phaeron's Court:} When taking a Phaeron, you may also take up to 2 Lords or Nemesor Lords without using up an additional Force Organization Slot. 
