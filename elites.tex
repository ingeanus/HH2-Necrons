...
\begin{tabular}{||m{532pt}||}
	...
	Abilities \\
	\hline
	\quickref{Awakening Protocls} (Silver), Fearless, \quickref{Living Metal}, \quickref{Reanimation Protocols} \\
	\hline
\end{tabular}
...
\begin{tabular}{||m{532pt}||}
	...
	Abilities \\
	\hline
	\quickref{Awakening Protocls} (Bronze), Fearless, \quickref{Living Metal}, \quickref{Reanimation Protocols} \\
	Royal Guard: Only a single unit of Lychguard may be purchased for each Nemesor and/or Overlord and are treated as their personal retinue. They take up a single Force Organisation chart choice with that Character, but do not have to be deployed with them and are treated as a separate unit during the game. In addition they count as within Nodal Command Range of their respective HQ while they are both on the table. \\
	\hline
\end{tabular}