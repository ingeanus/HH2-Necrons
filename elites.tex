...
\begin{tabular}{||m{140pt} m{0pt} m{31pt} m{55pt} m{12pt} m{12pt} m{210pt}||}
	...
	Name & & Range & Type & S & AP & Abilities \\
	\hline
	Scythe of the Nightbringer (Reaping Sweep) &  & — & Melee & User & 3 & Murderous Strike (6+), Reaping Blow (4) \\
	Scythe of the Nightbringer (Entropic Blow) &  & — & Melee & x2 & 2 & Brutal (3), Murderous Strike (6+),Two-Handed \\
	\hline
\end{tabular}
