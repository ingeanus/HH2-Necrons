\supersection{Necron Factions}

\newpage
\supersubsection{Charnovokh}
...
\begin{itemize}
	\item \quickref{Stellar Energetic Reactors} \dotfill +10 points per model.
	\item \quickref{Heavy Reactor Energetics} \dotfill +10 points per model.
\end{itemize}
...
\begin{multicols}{2}
	...
	\textbf{Nihilakh Warlord Trait (Warlord Trait)}
	
	\textit{Trait Description Here.}
\end{multicols}



\newpage
\supersubsection{Novokh}
...
\newpage
\supersubsection{Destroyer Cult}
