\section[Necron Factions]{\superhuge{Necron Factions}}

\newpage
\subsection[Charnovokh]{\superlarge{Charnovokh}}
...
\newpage
\subsection[Maynarkh]{\superlarge{Maynarkh}}
...
\begin{itemize}
	\item \quickref{Mark of the Flayer} special rule \dotfill -2 points.
...
\newpage
\subsection[Mephrit]{\superlarge{Mephrit}}
...
\begin{itemize}
	\item \quickref{Stellar Energetic Reactors} \dotfill +2 points per model.
	\item \quickref{Heavy Reactor Energetics} \dotfill +5 points per model.
\end{itemize}

\vspace*{2em}
\fbox{\begin{imgminipage}{white_marble.jpg}{\textwidth-4em}
		\textbf{Advanced Reaction (Solar Fury)}
...
\newpage
\subsection[Nephrekh]{\superlarge{Nephrekh}}
...
\begin{itemize}
	\item \quickref{Living Gold} \dotfill +5 points.
\end{itemize}

\vspace*{2em}
\fbox{\begin{imgminipage}{white_marble.jpg}{\textwidth-4em}
		\textbf{Advanced Reaction (Beings of Light)}
...
\newpage
\subsection[Nihilakh]{\superlarge{Nihilakh}}
...
\begin{itemize}
	\item \quickref{Yyth Seer} \dotfill +X points.
\end{itemize}

Any Dyastic Warrior model with the Necron Dynasty (Nihilakh) special rule may take any of the following:
\begin{itemize}
	\item \quickref{Metagold Reinforcement} \dotfill +5 points per model
\end{itemize}

\vspace*{2em}
\fbox{\begin{imgminipage}{white_marble.jpg}{\textwidth-4em}
		\textbf{Advanced Reaction (Aggressively Territorial)}
		
		At the start of the game, any army with this Advanced Reaction must secretly nominate one of the objectives or a point on the map to be their Prized Territory. Once per battle, during the Movement phase when an enemy unit moves within 6" of the Prized Territory (or 9" if it is an objective), this reaction may be made. Any friendly units eligible to make a Reaction within 12" of the Prized Territory composed of models with the Necron Dynasty (Nihilakh) special rule may immediately make either a Shooting Attack or Charge against the enemy unit that triggered this Reaction. A Charge declared as part of this Reaction is resolved immediately (the enemy unit may not declare any Reaction against this Charge), and if successful the combat will be fought as normal in the following Assault phase, with a Charging unit with the Necron Dynasty (Nihilakh) special rule gaining all the normal benefits of Charging. Any unit that makes a Shooting Attack or Charge as part of this Reaction counts as having made a Reaction in this Phase.
		
		\vspace*{1em}
		A unit that makes a Shooting Attack as part of a Aggressively Territorial Reaction may not make any attacks indirectly (without line of sight) including weapons with the Barrage special rule or other weapons or special rules that otherwise ignore line of sight, and Vehicles may only fire Defensive Weapons. Template weapons may only be used as part of a Aggressively Territorial Reaction if the target unit is within 8" and must use the Wall of Death rule instead of firing normally.
\end{imgminipage}}
\vspace*{1em}
...
\newpage
\subsection[Novokh]{\superlarge{Novokh}}
...
\newpage
\subsection[Sautekh]{\superlarge{Sautekh}}
...
\newpage
\subsection[Szarekhan]{\superlarge{Szarekhan}}
...
\textbf{Necron Dynasty (Szarekhan) (Uncanny Artifice):} Units with this special rule may gain the Stubborn special rule. % TODO: More?

\textbf{Szarekhan:}


\newpage
\subsection[Thokt]{\superlarge{Thokt}}
...
\begin{itemize}
	...
	\item \quickref{Rad-Receptors} \dotfill +1 points.
\end{itemize}
...
\newpage
\subsection[Triarch]{\superlarge{Triarch}}
...
\textbf{Triarch:} TODO: More. Units with this special rule and the \quickref{Decurion Nemesor} or \quickref{Tesserarion Nemesor} special rule may also take a \quickref{Triarch Praetorian Vanguard} or \quickref{Triarch Judicator Vanguard} unit as an option for that special rule.

\textbf{Triarch:}


\newpage
\subsection[Destroyer Cult]{\superlarge{Destroyer Cult}}
...
\newpage
\subsection[Flayed Ones]{\superlarge{Flayed Ones}}
...
\textbf{Flayed Ones:} TODO: More. Units with this special rule and the \quickref{Decurion Nemesor} or \quickref{Tesserarion Nemesor} special rule may also take a \quickref{Triarch Praetorian Vanguard} unit as an option for that special rule.
