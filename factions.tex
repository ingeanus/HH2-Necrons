...
\vspace*{2em}
\fbox{\parbox{\textwidth-4em}{\textbf{
Advanced Reaction (Wrath of Llandu'gor)} 
...
\vspace*{2em}
\fbox{\parbox{\textwidth-4em}{\textbf{
			Advanced Reaction (Beings of Light)}
...
\vspace*{2em}
\fbox{\parbox{\textwidth-4em}{\textbf{
			Advanced Reaction (Aggressively Territorial)}
...
\vspace*{2em}
\fbox{\parbox{\textwidth-4em}{\textbf{
			Advanced Reaction (Blood Engrams)}
