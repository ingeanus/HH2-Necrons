\supersection{Wargear}


\supersubsection{Ranged Weapons} \label{Ranged Weapons}
...
\supersubsection{Close Combat Weapons} \label{Close Combat Weapons}
...
\begin{NiceTabular}{L{115 pt} c C{40pt} *{2}{c} >{\raggedright\arraybackslash}p{240pt}}
	...
	\cellgray{6}{} \quickref{Hyperphase Sword} & — & Melee & User & 3 & Rending (5+) \\
	\quickref{Hyperphase Reap-Blade} & — & Melee & +2 & 2 & Murderous Strike (5+), Two-Handed \\
	\cellgray{6}{} \quickref{Hyperphase Thresher} & — & Melee & User & 3 & Reaping Blow (1), Specialist Weapon \\
\end{NiceTabular}
...
\supersubsection{Technoarkana} \label{Technoarcana}
...
\newpage
\supersubsection{Artefacts of the Aeons} \label{Artefacts of the Aeons}
