...
\begin{NiceTabular}{L{115 pt} c C{40pt} *{2}{c} >{\raggedright\arraybackslash}p{240pt}}
	Name & Range & Type & S & AP & Abilities \\
	\hline
	\quickref{Conduit of Stars} & 36" & Rapid Fire & 6 & 4 & \quickref{Gauss} (6+), Master-Crafted, Twin-Linked \\	
\end{NiceTabular}
...
\begin{NiceTabular}{L{115 pt} c C{40pt} *{2}{c} >{\raggedright\arraybackslash}p{240pt}}
	Name & Range & Type & S & AP & Abilities \\
	\hline
	\cellgray{6}{} \quickref{The Arrow of Infinity Arrow} & $\infty$ & Assault 1 & 16 & 1 & Destructor, Master-Crafted, One use, \quickref{Path of Annihilation} (1) \\
\end{NiceTabular}
