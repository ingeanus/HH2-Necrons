...
\begin{tabular}{||m{110pt} m{30pt} m{31pt} m{55pt} m{12pt} m{12pt} m{210pt}||}
	...
	\quickref{Tachyon Arrow} & & $\infty$ & Assault 1 & 10 & 1 & Destructor, One use, Path of Annihilation \\
	\hline
\end{tabular}

\textbf{Path of Annihilation:} When the weapon with this special rule is used to make a Shooting Attack, draw a $\frac{1}{2}$" wide line from the model up to the listed range of the weapon — this is the projectile's path.
